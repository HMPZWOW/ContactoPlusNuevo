...
{ 
    ...
    internal class clArchivos
       
    {
       private readonly string rutaArchivo;

        public clArchivos(string ruta = "directorio.txt")
        {
        ...
        public List<Contacto> show()
        {
            ...
            while ((linea = lector.ReadLine()) != null)
            {
                ...
                //int id,string nombre,string apellidos,int telefono,int extension, string puesto,string empresa, string observaciones,string correo
                ...
                contacto.status = Convert.ToBoolean(datos[9]);
